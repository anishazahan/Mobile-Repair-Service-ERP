...
const SKILLS = [
  {
    title: "Diagnostics",
    description: "Every repair starts with a free, no-obligation inspection so you know exactly what's wrong before you commit to anything.",
  },
  {
    title: "Replacement",
    description: "Screens, batteries, cameras and ports are swapped using genuine or OEM-grade parts, backed by a real warranty.",
  },
  {
    title: "Device Repair",
    description: "From water damage to board-level faults, our senior technicians handle the repairs other shops turn away.",
  },
];
      ...
      <div className="grid items-start gap-16 lg:grid-cols-2">
        <div className="space-y-5">
          ...
          <p className="text-muted-foreground">
            Every technician on our floor is trained across the major brands and repair
            categories below, so whatever walks through the door, someone on shift can handle it
            the same day.
          </p>
