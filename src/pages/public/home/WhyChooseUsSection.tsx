...
const REASONS = [
  {
    ...
    description:
      "Most repairs are completed the same day, some in under an hour.",
  },
  {
    icon: ShieldCheck,
    title: "Two Years Warranty",
    description:
      "Every repair is backed by a genuine warranty on parts and labor.",
  },
  {
    icon: Users,
    title: "Expert Technicians",
    description: "Certified and specialized across every major device brand.",
  },
  {
    icon: Cog,
    title: "Quality Parts",
    description:
      "We never use counterfeit components — sourced from vetted suppliers.",
  },
];
    ...
    <section className="bg-primary text-primary-foreground">
      <div className="grid lg:grid-cols-2">
        ...
        >
          <img
            src={IMAGE}
            alt="Technician holding professional repair tools"
        ...
        <div className="space-y-8 px-6 py-16 sm:px-10 lg:px-16">
          <Reveal direction="right" className="space-y-4">
            ...
            <p className="text-primary-foreground/85">
              We treat every device like it's our own honest diagnostics, fair
              pricing, and work that holds up long after you walk out the door.
            </p>
          </Reveal>
          ...
          <Reveal
            direction="right"
            delay={480}
            className="flex flex-wrap gap-10 border-t border-white/20 pt-6"
          >
            {STATS.map((stat) => (
              <div key={stat.label}>
